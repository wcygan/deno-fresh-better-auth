  ...
  return (
    <div class="card w-full max-w-sm mx-auto">
      <header>
        ...
        <p>Enter your details below to {mode === "login" ? "login to" : "create"} your account</p>
      </header>

      <section>
        <form onSubmit={onSubmit} class="form grid gap-6" aria-busy={loading}>
          {mode === "signup" && (
      ...
      <footer class="flex flex-col gap-4">
        ...
        <p class="text-center text-sm">
          ...
          <button
            ...
            class="underline-offset-4 hover:underline disabled:opacity-60"
            disabled={disabled}
          >
